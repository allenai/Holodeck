...
class SmallObjectGenerator():
    ...
    def generate_small_objects(self, scene, controller, receptacle_ids):
        ...
        if "receptacle2small_objects" in scene and self.reuse_assets: receptacle2small_objects = scene["receptacle2small_objects"]
        else: receptacle2small_objects = self.select_small_objects(object_selection_plan, receptacle_ids, receptacle2asset_id)
        ...
        for receptacle, small_objects in receptacle2small_objects.items():
            ...
            for object_name, asset_id, _ in small_objects:
                ...
                small, y_rotation = self.check_small_asset(asset_id) # check if the object is small and rotate around y axis randomly
                ...
                if obj != None: # If the object is successfully placed
                    ...
                    if small: placement["rotation"]["y"] = y_rotation # temporary solution for random rotation around y axis for small objects
    ...
    def select_small_objects(self, object_selection_plan, recpetacle_ids, receptacle2asset_id):
        ...
        packed_args = [(receptacle, small_objects, receptacle2asset_id) for receptacle, small_objects in receptacle2small_object_plans.items()]
    ...
    def select_small_objects_per_receptacle(self, args):
        ...
        for small_object in small_objects:
            ...
            for i in range(quantity):
                ...
                num_objects += 1
                if capacity > receptacle_area * 0.9 and num_objects > 1: print(f"Warning: {receptacle} is overfilled."); break
                if num_objects > 15: print(f"Warning: {receptacle} has too many objects."); break
